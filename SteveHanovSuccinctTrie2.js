...
All credit goes to Steve Hanov

Source:

Blog Post: https://stevehanov.ca/blog/?id=120

Code Lio
COde Link
Code Lik
Code Link: https://www.hanovsolutions.com/trie/Bits.js
...
FrozenTrie.prototype = {
    ...
    /**
      ...
      in the trie.
      */
    /*lookup: function(self=this, node1root, word ) 
    {
...
//Fo
//FrozenTrie.lool
/*FrozenTrie.prototype.lookup = function(self=this, node1root, word ) 
{
    //var node = this.getRoot();
    //let node = this.getNodeByIndex(0;)
    //let node= this.getNodeByIndex(0);
...
/*FrozenTrie.prototype.lookup = function(word) {
    let node = this.getNodeByIndex(0);
    //for (let i = 0; i < word.length; i +)
    for (let i = 0; i < word.length; i++) {
        //let dh
...
export {FrozenTrie, FrozenTrieNode, BitString, BitWriter, Trie, TrieNode};