...
//if
        ...
        //
        //
        //ctx.fillText(item.toUpperCase(), drawLeft2 + (drawOffset * i), textDrawLocation);
        //
    }
    //
    //
    //ctx.font = "12px a"
    ctx.font = "12px Arial";
    ctx.fillText(`Failed: ${failedCount} : Correct: ${correctCount}`, centerx, statsLocation);
    //
}
...
//
    ...
    if (currentText.includes(requiredText)) {
        //
        //if (donotuse.inl)
        //if (donotuse.includes(currentText)) return;
        //
        //
        //if (dict.lookup)
        ...
        if (dict.lookup(dict.getNodeByIndex(0), currentText)) {
            ...
            console.log(node,);*/
            //
            //if (donotuse.includes(currentText)) {
            //if (d)
            //f
            if (!donotuse.includes(currentText)) {
            //
